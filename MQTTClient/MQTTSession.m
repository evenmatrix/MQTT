        ...
        case MQTTEncoderEventReady:
            switch (self.status) {
                case MQTTSessionStatusCreated:{
                    MQTTMessage *connectMessage = self.connectMessage;
                    if (!connectMessage && self.delegate && [self.delegate connectMessageAtSessionCreated:self]) {
                        connectMessage = [self.delegate connectMessageAtSessionCreated:self];
                    }
