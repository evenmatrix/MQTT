...
NSString *const  MQTTSessionConnectedNotification = @"com.youku.MQTT.MQTTSessionConnectedNotification";
...
- (MQTTMessage *)connectMessageAtSessionCreated:(MQTTSession *)session {
    if (self.delegate && [self.delegate sessionManager:self connectMessageWithSession:session]) {
        return [self.delegate sessionManager:self connectMessageWithSession:session];
    }else {
        return nil;
    }
}
    ...
    switch (eventCode) {
        case MQTTSessionEventConnected:
        {
            ...
            dispatch_async(dispatch_get_main_queue(), ^{
                NSNotificationCenter *defaultCenter = [NSNotificationCenter defaultCenter];
                [defaultCenter postNotificationName:MQTTSessionConnectedNotification object:nil];
            });    
            break;
        }
